...
const PreviewPage = () => {
  ...
  return (
    <div>
      <div className="mt-20">
        <section>
          <div className="container-fluid min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white">
            <h4 className="text-center mt-3 mb-3 text-xl md:text-2xl font-semibold">
              Play Online - {game.name}
            </h4>

            <div className="game-area w-full flex-grow flex justify-center items-center relative">
              <iframe
                className="w-4/5 h-[70vh] md:h-[75vh] lg:h-[80vh] border-none"
                src={game?.iframe}
                allowFullScreen
              ></iframe>
            </div>

            <div className="w-full bg-gray-800 text-gray-100 flex flex-col lg:flex-row justify-center lg:justify-between items-center py-4 px-6">
